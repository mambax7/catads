...
xoops_cp_header();
catads_admin_menu(0, _AM_CATADS_ABOUT );
...
echo "<div style = 'line-height: 16px; font-weight: bold; display: block;'>" . _AM_CATADS_BY . " " .$author_name;
echo "</div>";
...
echo "<tr>";
echo "<td colspan='2' class='bg3' align='left'><strong>" . _AM_CATADS_MODULE_INFO . "</strong></td>";
echo "</tr>";

If ( $versioninfo->getInfo('status') != '' )
{
        echo "<tr>";
        echo "<td class='head' width='200' align='left'>" . _AM_CATADS_MODULE_STATUS . "</td>";
...
{
        echo "<tr>";
        echo "<td class='head' align='left'>" . _AM_CATADS_MODULE_DEMO . "</td>";
...
{
        echo "<tr>";
        echo "<td class='head' width='150px' align='left'>" . _AM_CATADS_AUTHOR_EMAIL . "</td>";
...
{
        echo "<tr>";
        echo "<td class='head' align='left'>" . _AM_CATADS_MODULE_SUPPORT . "</td>";
...
{
        echo "<tr>";
        echo "<td class='head' align='left'>" . _AM_CATADS_MODULE_BUG . "</td>";
        echo "<td class='even' align='left'><a href='" . $versioninfo->getInfo('submit_bug') . "' target='blank'>" . _AM_CATADS_MODULE_BUG . "</a></td>";
        echo "</tr>";
}
If ( $versioninfo->getInfo('submit_feature') != '' )
{
        echo "<tr>";
        echo "<td class='head' align='left'>" . _AM_CATADS_MODULE_FEATURE . "</td>";
        echo "<td class='even' align='left'><a href='" . $versioninfo->getInfo('submit_feature') . "' target='_blank'>" . _AM_CATADS_MODULE_FEATURE . "</a></td>";
        echo "</tr>";
}
...
If ( $versioninfo->getInfo('warning') != '' )
{
        ...
        echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
        echo "<tr>";
        echo "<td class='bg3' align='left'><strong>" . _AM_CATADS_MODULE_DISCLAIMER . "</strong></td>";
        echo "</tr>";
...
If ( $versioninfo->getInfo('author_word') != '' )
{
        ...
        echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>";
        echo "<tr>";
        echo "<td class='bg3' align='left'><strong>" . _AM_CATADS_AUTHOR_WORD . "</strong></td>";
        echo "</tr>";
