...
class catadsFormTextDateSelect extends XoopsFormText
{

	function catadsFormTextDateSelect($caption, $name, $size = 15, $value= 0)
	{
...
//		return "<input type='text' name='".$this->getName()."' id='".$this->getName()."' size='".$this->getSize()."' maxlength='".$this->getMaxlength()."' value='".date("Y-m-d", $this->getValue())."'".$this->getExtra()." /><input type='reset' value=' ... ' onclick='return calendar.show(\"".$this->getName()."\");'>";
	}
}
?>