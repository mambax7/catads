...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//Requete
$sqlDatas = mysql_query("SELECT `$champCodePostal`, `$champPays` FROM `$tableUtilisee` WHERE `$champWaiting` = '0' AND `$champSuspend` = '0' AND ".time()." < `$champExpired` ORDER BY `$champCodePostal`");
if (!$sqlDatas) {
